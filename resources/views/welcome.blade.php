  ...
  <body>
                ...
                <div class="panel-heading">
                    <h4>Contact list
                      <div class="pull-right">
                          <a onclick="addForm()" class="btn btn-primary" style="margin-top: -8px;"> <span class="glyphicon glyphicon-plus"></span>  Add Contact </a>
                          <a href="{{ route('contact.export') }}" class="btn btn-success" style="margin-top: -8px;"> <span class="glyphicon glyphicon-print"></span>  Print Data </a>
                      </div>
                    </h4>
                </div>
    ...
    <script type="text/javascript">
      ...
      function deleteData(id){
        // var popup = confirm("Yakin akan menghapus data?");
        var csrf_token = $('meta[name="csrf-token"]').attr('content');
        // if (popup == true) {
        swal({
          title: 'Yakin hapus?',
          text: 'Anda tidak akan bisa membatalkan jika memilih Ya!',
          type: 'warning',
      ...
      $(function(){
        $('#modal-form form').validator().on('submit', function(e) {
          if (!e.isDefaultPrevented()) {
            ...
            else url = "{{ url('contact') . '/' }}" + id_contact;
